...
<body>
	...
	java.util.List<com.lms.models.Employer> emps = 
			(java.util.List<com.lms.models.Employer>) request.getAttribute("employers");
	...
	<div class='containers'>
		<div class='row'>
<!-- 			<div class='col col-3 left'></div> -->
			<div class='col right'>
				<c:if test="${employers.size() == 0}">
					<h3>No employers to display!</h3>
				</c:if>
				<c:if test="${employers.size() != 0}">
							...
							<div class="card-body">
								<div class='row'>
									<div class='img col-3'>
										...
										<!-- 											width='100px'> -->
										<h4 class='card-title'>${emp.username}</h4>
									</div>
									<div class='col'>
